	...
	*/
	...
	var TaxiController = (function (SiftController) {
	  ...
	  TaxiController.prototype.loadView = function loadView (state) {
	    ...
	    return {
	      html: "view.html",
	      data: Promise.all(p).then(function (results) {
	        return {
	          webhooks: {
	  ...
	  TaxiController.prototype.onStorageUpdate = function onStorageUpdate (value) {
	    ...
	    Promise.all(ps).then(function (results) {
	      this$1.publish('storageupdate', { data: results[0], config: results[1] });
	    });
	  };
	  ...
	  TaxiController.prototype.getConfig = function getConfig () {
	  ...
	  TaxiController.prototype._getTodayData = function _getTodayData () {
	    return this.storage.get({
	      bucket: 'day',
	      keys: [moment$1().utc().startOf('day').valueOf().toString()]
