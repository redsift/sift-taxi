...
var TaxiEmailClientController = (function (EmailClientController) {
  ...
  if ( EmailClientController ) TaxiEmailClientController.__proto__ = EmailClientController;
  TaxiEmailClientController.prototype = Object.create( EmailClientController && EmailClientController.prototype );
  TaxiEmailClientController.prototype.constructor = TaxiEmailClientController;

  // TODO: remove. test-only
  TaxiEmailClientController.prototype.onstats = function onstats (name, value) {
    console.log('[TaxiEmailController::onstats]: ', name, value);
  };

  TaxiEmailClientController.prototype.loadThreadListView = function loadThreadListView (listInfo) {
    console.log('sift-taxi: loadThreadListView: ', listInfo);
    var label = this._currencySymbols[listInfo.currency] + listInfo.total;
    if (listInfo.converted === true) {
      label = '~' + label;
    }
    var ret = {
      template: '001_list_common_txt',
      value: this._companyColors[listInfo.company]
    };
...
export default TaxiEmailClientController;